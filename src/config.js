...
let DEFAULT_CORS_ALLOWED_ORIGINS = [
  "http://localhost:3003",
  DOCKER_NETWORK_RANGE_REGEXP,
];
...
if (ENV === "development") {
  DEFAULT_ACCESS_TOKEN_SECRET =
    DEFAULT_ACCESS_TOKEN_SECRET || "your_access_token_secret_here";
  DEFAULT_REFRESH_TOKEN_SECRET =
    DEFAULT_REFRESH_TOKEN_SECRET || "your_refresh_token_secret_here";
...
if (!DEFAULT_ACCESS_TOKEN_SECRET || !DEFAULT_REFRESH_TOKEN_SECRET) {
  throw new Error(
    "ACCESS_TOKEN_SECRET and REFRESH_TOKEN_SECRET must be set in all environments."
  );
}
...
const SAME_SITE =
  SAME_SITE_TYPES[DEFAULT_SAME_SITE.toUpperCase()] || SAME_SITE_TYPES.STRICT;
